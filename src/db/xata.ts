...
const tables = [
  {
    ...
    columns: [
      ...
      { name: "role", type: "text" },
      { name: "bio", type: "text" },
      { name: "is_member", type: "bool", notNull: true, defaultValue: "false" },
      { name: "status", type: "text", notNull: true, defaultValue: "pending" },
      { name: "gender", type: "text" },
      { name: "phone", type: "text" },
      { name: "socials", type: "json", defaultValue: "[]" },
    ],
    revLinks: [
...
const defaultOptions = {
  databaseURL: "https://Bitworks-s-workspace-vfdbgb.us-east-1.xata.sh/db/prod",
};
